...
#ifndef NAV2_BEHAVIOR_TREE__PLUGINS__CONTROL__RATE_PIPELINE_SEQUENCE_HPP_
#define NAV2_BEHAVIOR_TREE__PLUGINS__CONTROL__RATE_PIPELINE_SEQUENCE_HPP_
 ...
 */
class RatePipelineSequence : public BT::ControlNode
{
public:
  /**
   * @brief A constructor for r4c_navigation::RatePipelineSequence
   * @param name Name for the XML tag for this node
   */
  explicit RatePipelineSequence(const std::string & name);
   ...
   */
  RatePipelineSequence(const std::string & name, const BT::NodeConfiguration & config);
...
#endif  // NAV2_BEHAVIOR_TREE__PLUGINS__CONTROL__RATE_PIPELINE_SEQUENCE_HPP_